!****************************************************************************
!   HEADING: MC3D VARIABLES MODULE FOR UNSTRUCTURED MESH
!   AUTHOR: 
!   PURPOSE: ALL THE GLOBAL CONSTANTS AND VARIABLES ARE DEFINED HERE.
!   DATE : 
!****************************************************************************
...
REAL*8,PARAMETER::zero_tol=1d-11
...
REAL*8,ALLOCATABLE::Ge_table(:,:),Si_table(:,:),Elimit(:,:)
...
REAL*8,ALLOCATABLE::dEcell(:),dEunit(:),dVunit(:),MFP(:),dTemp(:),dEdiff(:),tempEcell(:)
...
INTEGER*4,ALLOCATABLE::mlostL(:),mlostR(:),NemitL(:),NemitR(:),truePoolL(:),truePoolR(:)
INTEGER*4::WAY_DIR,Npool,Nmakeup
!-------------------------------------------------------------------------------
...
!****VARIABLES ABOUT RANDOM NUMBER GENERATOR
TYPE(rng_t)::RNseed0
TYPE(rng_t),ALLOCATABLE::RNseedMP(:)
INTEGER*4::CPUID

!****SIMULATION PARAMETERS
INTEGER*4::iter,iter0
INTEGER*4::nsteady,backup
INTEGER*4::cellinfoMethod
INTEGER*4::Ncore
REAL*8::time0,time
REAL*8::tStep,bundle(2)

!****OUTPUT DATA
REAL*8::qcenter
REAL*8, ALLOCATABLE:: Tz(:),qbdyL(:),qbdyR(:)
CHARACTER*72::inputfilename,outputfilename,restartfilename,gridfilename,groupfilename,casename
!===================================================================================
